    ...
    <S.MainWrapper>
      ...
      <S.SectionWrapper gray>
        ...
        <Typography variant="body1" align="center" sx={{ mt: 2 }}>
          ...
          and earning fixed interest back. They are generally <b>lower-risk</b>{" "}
          compared to stocks.
          <br />
          <br />
      ...
      <S.SectionWrapper>
        ...
        <Typography variant="body1" align="center" sx={{ mt: 2 }}>
          Gold has historically been a <b>safe-haven investment</b> — protecting
          your money during inflation and uncertainty.
          <br />
          <br />
      ...
      <S.SectionWrapper gray>
        ...
        <Typography variant="body1" align="center" sx={{ mt: 2 }}>
          ...
          <br />
          <br />
          In Pakistan, non-productive property buying (empty plots, speculation)
          has caused serious problems: frozen capital, inflation, and artificial
          land prices.
          <br />
          <br />
          AasaanFinance will explain — through blogs —{" "}
          <b>why productive real estate</b> (rental properties, commercial
          spaces) can create real wealth, while <b>land hoarding</b> often harms
          both you and the economy.
        </Typography>
      </S.SectionWrapper>
      ...
      <S.SectionWrapper>
        ...
        <Typography variant="body1" align="center" sx={{ mt: 2 }}>
          Investing in companies like Apple, Microsoft, or Amazon means growing
